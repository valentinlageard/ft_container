...
public:
	...
	explicit reverse_iterator(iterator_type it) : _base(iterator_type(it)) {}

	template <class value_type> reverse_iterator & operator=(const reverse_iterator<value_type> & other) {
		if (this == &other) {
			return *this;
		}
		_base = other._base;
